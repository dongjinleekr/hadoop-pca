...
public class CovarianceOptionCreator {
  ...
  public static DefaultOptionBuilder cardinalityOption() {
    return new DefaultOptionBuilder()
        .withLongName(CARDINALITY)
        .withRequired(true)
        .withShortName("c")
        .withArgument(
            new ArgumentBuilder().withName(CARDINALITY).withMinimum(1)
  ...
  public static DefaultOptionBuilder vectorCountOption() {
    return new DefaultOptionBuilder()
        .withLongName(VECTOR_COUNT)
        .withRequired(true)
        .withShortName("n")
        .withArgument(
            new ArgumentBuilder().withName(VECTOR_COUNT).withMinimum(1)
                .withMaximum(1).create())
